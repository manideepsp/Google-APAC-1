...
from app.services import sheets_pb2 as sheets__pb2
...
if _version_not_supported:
    raise RuntimeError(
        ...
        + ' but the generated code in sheets_pb2_grpc.py depends on'
...
def add_SheetsServiceServicer_to_server(servicer, server):
    ...
    server.add_registered_method_handlers('sheets.SheetsService', rpc_method_handlers)
